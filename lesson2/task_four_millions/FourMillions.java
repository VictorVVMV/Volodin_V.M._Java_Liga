package com.company.FIRST_HOMEWORK_FOURMILLIONSANDDEADLOCK.FourMillions;
...
public class FourMillions {
  ...
  static class Counter {
    ...
    /**
     * \
     * !!!Изначально отсутствовала синхронизация метода. Так как потоки могут прерываться, это может приводить к потере данных, ведь потоки
     * работают с общим объектом. Поэтому,чтобы избежать потери данных, мы прописываем синхронизацию метода этого объекта.!!!
     */
